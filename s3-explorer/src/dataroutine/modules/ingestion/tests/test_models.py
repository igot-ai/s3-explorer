...
class TestFileContext:
    ...
    def test_file_context_successful(self):
        ...
        file_ctx = FileContext(
            source_path="s3://bucket/file.pdf", status=FileStatus.UPLOADED
        )
...
class TestClassificationResult:
    ...
    def test_classification_result_creation(self):
        ...
        result = ClassificationResult(
            category_id="test-catalog", confidence=4, reason="High confidence match"
        )
...
class TestPipelineResult:
    ...
    def test_get_success_rate(self):
        ...
        result = PipelineResult(
            total_folders=1, total_files=10, successful=8, failed=2, folder_contexts=[]
        )
    ...
    def test_get_success_rate_zero_files(self):
        ...
        result = PipelineResult(
            total_folders=0, total_files=0, successful=0, failed=0, folder_contexts=[]
        )
