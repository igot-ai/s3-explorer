...
class TestSimpleZipExtractor:
    ...
    def test_extract_zip_file(self):
        ...
        try:
            file_ctx = FileContext(
                source_path="archive.zip", local_path=temp_zip, file_type="zip"
            )
    ...
    def test_extract_invalid_zip(self):
        ...
        try:
            file_ctx = FileContext(
                source_path="bad.zip", local_path=temp_path, file_type="zip"
            )
...
class TestArchiveExtractor:
    ...
    def test_compound_extensions(self):
        ...
        try:
            file_ctx = FileContext(
                source_path="archive.tar.gz", local_path=temp_path, file_type="gz"
            )
...
class TestDocxToPdfConverter:
    ...
    def test_process_without_libreoffice(self):
        ...
        try:
            file_ctx = FileContext(
                source_path="test.docx", local_path=temp_path, file_type="docx"
            )
