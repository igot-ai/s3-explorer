...
class TestIngestionPipeline:
    ...
    def test_pipeline_run_with_files(self, mock_components, sample_config):
        ...
        mock_components['source_connector'].download_file.return_value = io.BytesIO(b"pdf bytes")
    ...
    def test_extract_data_upload_dict_updates_metadata(self, mock_components, sample_config, tmp_path):
